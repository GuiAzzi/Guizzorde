...
export const jwProvidersEN = [
	...
	},
	{
		...
		addon_packages: ['prk', 'sru', 'ark', 'erk', 'srk'],
		parent_packages: null,
	},
	{
		id: 632,
	...
	},
	{
		...
		priority: 0,
		monetization_types: ['flatrate'],
		icon_url: '/icon/300778979/{profile}',
		icon_blur_hash: 'KS9HL{V:IWWCj[ay4moh%L',
		slug: 'sling-tv',
		data: {
			deeplink_data: [],
			packages: {
	...
	},
	{
		...
		short_name: 'aim',
		clear_name: 'Freevee Amazon Channel',
		display_priority: 10019,
		priority: 0,
		monetization_types: ['ads'],
		icon_url: '/icon/272702600/{profile}',
		icon_blur_hash: 'K$HeqOj?WF00kBWC-=ayoe',
		slug: 'freevee-amazon-channel',
		data: {
			deeplink_data: [],
			packages: {
				android_tv: 'enabled',
	...
	{
		id: 694,
		technical_name: 'cinessance',
		short_name: 'cen',
		clear_name: 'Cinessance',
		display_priority: 10027,
		priority: 0,
		monetization_types: ['flatrate', 'rent'],
		icon_url: '/icon/267115248/{profile}',
		icon_blur_hash: 'KARp8-xu~q%Mayj[~qofRj',
		slug: 'cinessance',
		data: {
			deeplink_data: [],
			packages: {
	...
	},
	{
		...
		short_name: 'f1t',
		clear_name: 'F1TV',
		display_priority: 10040,
		priority: 0,
		monetization_types: null,
		icon_url: '/icon/288883613/{profile}',
		icon_blur_hash: 'KVQEZcoLVEt7aeaeL#f6pI',
		slug: 'f1tv',
		data: {
			deeplink_data: [],
			packages: {
	...
	},
	{
		...
		display_priority: 10064,
		priority: 0,
		monetization_types: ['flatrate'],
		icon_url: '/icon/300814530/{profile}',
		icon_blur_hash: 'KzP7FKof%2ofj[WC~poeR*',
		slug: 'fox-sports-1',
		data: {
			deeplink_data: [],
			packages: {
