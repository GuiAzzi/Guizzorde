...
export class SNMWeek {
	...
	constructor(params) {
		...
		/** @type {[{userId: string, username: string, votes: Array, rating: string, movies: [{title: string, titleKey: number, compactMovieEmbed: import("discord.js").APIEmbed}]}]} Array of user objects */
